...
watch(
  () => dataLeadsVisit.searchLeadVisit,
  dataLeadsVisit.searchWithDelay
);
          ...
          <div class="card mb-4">
            ...
            <div class="table-responsive">
              <table class="table card-table table-vcenter text-nowrap">
                ...
                <tbody>
                <tr
                    v-for="(lvd, index) in dataLeadsVisit.leadVisitData"
                    :key="lvd.id"
                  >
                    <td>
                      {{
                        index + 1 +
                        dataLeadsVisit.pagination.per_page *
                          (dataLeadsVisit.pagination.current_page - 1)
                      }}.
                    </td>
