...
class QuotationValidationStore extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Snapshot NAMA/ALAMAT/PIC PERUSAHAAN -- auto-fill dari
            // customer_id di frontend, tapi tetap dikirim & divalidasi
            // di sini (bukan di-query ulang dari customer_id) supaya
            // sales bisa koreksi manual kalau data master-nya belum
            // update (mis. PIC sudah ganti tapi customer_id belum
            // sempat diedit).
